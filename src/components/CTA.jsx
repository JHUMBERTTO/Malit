...
const CTA = () =>(
  <section data-aos="zoom-in" data-aos-duration="1500" className= {`${styles.flexCenter} ${styles.marginY} ${styles.padding} sm:flex-row flex-col bg-black-gradient-2 rounded-[20px] box-shadow`}>
