...
import {headingMenu} from "../assets"
const Hero = () => (
<section id='inicio' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
  <div data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease--sine" data-aos-duration="1200"
    ...
    <h1
      className="font-poppins font-semibold ss:text-[68px] text-[52px] text-black ss:leading-[100px] leading-[75px] w-full">
      de creación digital</h1>
